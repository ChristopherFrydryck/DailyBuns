    ...
    return(
        <View {...allProps}>
            ...
            <Lightbox 
                ...
                : null }
                 <Image source={post.data.images.thumbnail.uri.length > 0 ? {uri: post.data.images.thumbnail.uri} : require("../assets/images/ProfilePic-DailyBuns.jpg")} style={{width: 64, height: 64, marginRight: 8}}/>
                 </View>
                </Lightbox>
